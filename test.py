...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_path', type=str, default='your model path/model.pth')
    parser.add_argument('--test_path', type=str,
                        default='your testdata path', help='path to test dataset')
    parser.add_argument('--save_path', type=str, default=None, help='path to save inference segmentation')

    opt = parser.parse_args()

    model = AttTransCFusion().cuda()
